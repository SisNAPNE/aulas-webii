                ...
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item dropdown ps-2">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a href="{{route('reports', 0)}}" class="dropdown-item" target="_blank">
                            ...
                            <li>
                                <a href="{{route('reports', 1)}}" class="dropdown-item" target="_blank">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#198754" class="bi bi-car-front-fill" viewBox="0 0 16 16">
                            ...
                            <li>
                                <a href="{{route('reports', 2)}}" class="dropdown-item">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#198754" class="bi bi-palette" viewBox="0 0 16 16">

@extends('templates/main', ['titulo'=>"Alterar Nível de Formação"])

@section('conteudo')

<form action="{{ route('niveis.update', $data->id) }}" method="POST">
    @csrf
    @method('PUT')
    <div class="row">
        <div class="col" >
    ...
    <div class="row">
        <div class="col">
            <a href="{{route('niveis.index')}}" class="btn btn-secondary btn-block align-content-center">

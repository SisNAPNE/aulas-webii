@extends('templates/main', ['titulo'=>"Alterar Ocorrência"])

@section('conteudo')

<form action="{{ route('ocorrencias.update', $data->id) }}" method="POST">
    @csrf
    @method('PUT')
    ...
    <div class="row">
        <div class="col" >
            ...
            <div class="form-floating mb-3">
                <input 
                    type="text" 
                    class="form-control @if($errors->has('assunto')) is-invalid @endif" 
                    name="assunto" 
                    placeholder="Assunto"
                    value="{{$data->assunto}}"
                />
                <label for="assunto">Assunto da Ocorrência</label>
    ...
    <div class="row">
        <!-- <div class="col-xl-10 col-lg-10 col-sm-9 col-8" > -->
        <div class="col">
            <div class="form-floating mb-3">
                <textarea
                    type="text"
    ...
    <div class="row">
        <div class="col">
            <a href="{{route('ocorrencias.index')}}" class="btn btn-secondary btn-block align-content-center">
